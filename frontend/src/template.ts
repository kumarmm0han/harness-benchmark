// The valid template from spec.md §3 — inserted verbatim by the Editor.
// Must be byte-identical to the backend seed (SeedTemplate.BILLING_REFUND)
// and the test fixture (com.sop.domain.Tpl.VALID).
