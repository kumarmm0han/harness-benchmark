// The exact valid template from spec.md §3 (also the seed fixture). Inserted verbatim
// into the editor. Keep byte-identical to spec.md — `template.test.ts` guards this.
